...
try:
    ...
    parser.add_argument("pick_funk", help = "Which function do you want?", type = str)
    parser.add_argument("x1", help = "This is the x of your first point", type = int)
    parser.add_argument("y1", help = "This is the y of your first point", type = int)
    parser.add_argument("x2", help = "This is the x of your second point", type = int)
    parser.add_argument("y2", help = "This is the y of your second point", type = int)

    args = parser.parse_args()
    input_function = args.pick_funk
    x1 = args.x1
    y1 = args.y1
    x2 = args.x2
    y2 = args.y2
